...
* Bugfix : Vulnerability fix.
* Update : BWS panel section was updated.
* Pro : Bug with downloading message has been fixed.
...
= V1.5.7 - 14.04.2017 =
* Bugfix : Multiple Cross-Site Scripting (XSS) vulnerability has been fixed.
